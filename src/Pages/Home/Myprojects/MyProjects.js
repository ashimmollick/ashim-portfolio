            ...
            <div className='grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href="https://headphone-relase.web.app" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href="https://criminal-lawyer-1756d.web.app" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href=" https://shofol-academy-school.web.app/" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href="https://idyllic-dasik-4d5733.netlify.app/" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href="https://ubiquitous-meerkat-9f96a3.netlify.app/" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary"><a href="https://magical-meerkat-a19f3b.netlify.app/" target="_blank">Vied Details</a></button>
                        </div>
                    </div>
                </div>
            </div>
